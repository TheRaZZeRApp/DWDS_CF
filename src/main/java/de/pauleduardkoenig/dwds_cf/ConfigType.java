...
public enum ConfigType implements ConfigEnum<ConfigType>{
	...
	JSON_COLLAPSE_LEVEL("1"),
	JSON_COMBINE(true),
	TCF_INDENT_LEVEL("2"),
	TCF_INDENT(" "),
	CSV_REMOVE_DUPLICATES(true),
	CSV_AUTOTAG(false),
	CSV_AUTOTAG_LIST("./data/tags.csv"),
	CSV_AUTOTAG_SOURCE_COLUMN("1"),
	CSV_AUTOTAG_COLUMN("2"),
	CSV_AUTOTAG_COLUMN_NAME("Tag"),
	CSV_AUTOTAG_LEMMATIZE(true),
	CSV_SPACES("0"),
